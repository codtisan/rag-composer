...
const AverageLatencyCard = () => {
  return (
    <Card className="size-full flex items-center justify-center">
      <span className="font-bold text-2xl">Average Latency</span>
      <span className="font-bold text-2xl">1000 ms</span>
...
export default AverageLatencyCard;
